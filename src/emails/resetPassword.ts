...
<body style="font-family: 'Open Sans', sans-serif; color: #6B705C; margin: 0; ">
  <div style="width: 90%; height: 100%; margin: auto;">
    ...
    <a style="text-decoration: none;" href=${process.env.ORIGIN}/change-password/${token}}>
  ...
  <div style="display: flex; width: 95%; padding: 3rem 2rem 0 2rem;">
    <div style="display: flex; width: 50%;">
      ...
      <div style="width: 50%;">
        ...
        <div>
          <a style="color: #6B705C;" href="https://floristabeijaflor.com/perguntas">Perguntas frequentes</a>
        </div>
      </div>
    </div>
    <div style="width: 50%;">
