...
<html lang="en">
  ...
  <body style="font-family: 'Open Sans', sans-serif; color: #6b705c; margin: 0">
    <div style="width: 100%; max-width: 1024px; height: 100%; margin: auto">
      <div style="display: flex; width: 90%; margin-top: 2rem; margin: auto;">
      ...
      <h3
        ...
        "
      >
        A sua encomenda com ID <strong>${orderId}</strong> está em processamento. Enviaremos um email assim que mude de estado.
      </h3>
      <div style="display: flex; width: 90%; max-width: 800px; height: 80px; border: 1px solid #c5c5c5; border-radius: 6px; margin: 5rem auto; padding: 1rem;">
        <div style="height: 100%; width: 30%; background-color: #f5fae8; border-radius: 8px; margin-right:auto; display: flex;">
          <h5 style="margin: auto; text-align: center; color: #6b705c;">Em processamento</h5>
        </div>
        <div style="height: 100%; width: 30%; border-radius: 8px; margin:auto; display: flex; border: 1px solid #c5c5c5;">
          <h5 style="margin: auto; text-align: center; font-weight: 400; color: #6b705c;">Em distribuição</h5>
        </div>
        <div style="height: 100%; width: 30%; border-radius: 8px; margin-left:auto; display: flex; border: 1px solid #c5c5c5;">
          <h5 style="margin: auto; text-align: center; font-weight: 400; color: #6b705c;">Entregue</h5>
        </div>
      </div>
      <h3
      style="
